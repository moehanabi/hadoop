...
public class CompressOutputStream extends FilterOutputStream implements
  ...
  private final ArrayList<Long> uncompressedIndexes;
  private final ArrayList<Long> compressedIndexes;
  ...
  /**
   * To flush, we need to compress the data in the buffer and write to the
